...
export function Model({ props, setCurrentIndex, currentIndex }) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <e.group theatreKey="laptopScreen">
        <mesh
          ref={meshRef1}
      ...
      {/* <mesh name="Cube002_Material001_0_Baked" geometry={nodes.Cube003_Material001_0_Baked.geometry} material={materials['Cube.002_Material.001_0_Baked.001']} position={[0.878, 0.203, -0.137]} rotation={[0, -0.999, -Math.PI / 2]} scale={[0.09, 0.122, 0.006]} /> */}
      ...
      <mesh
        ...
        position={[1.193, 1.176, 0.058]}
        rotation={[Math.PI / 2, 0, Math.PI / 2]}
        scale={0.265}
      >
        <meshStandardMaterial
          emissive="red"
          emissiveIntensity={10}  // Augmenté de 5 à 10
          toneMapped={false}
          color="red"  // Ajouté pour renforcer la couleur de base
          metalness={0.5}  // Ajouté pour donner un aspect plus métallique
          roughness={0.2}  // Réduit pour augmenter la brillance
        />
      </mesh>
